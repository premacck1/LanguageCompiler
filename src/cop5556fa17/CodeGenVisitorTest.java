...
/*@Test
public void imageGenM() throws Exception{
	devel = false;
	grade = true;
	String prog = "imageGenM";
	String input = prog
			+ "\n image[512,512] g <- \"C://Users//Prem Ankur//Pictures//heart_anim.png\"; \n"
			+ "g -> SCREEN;\n";
	//String input = prog + "\n image g <- \"C://Users//Nishant//Desktop//Fall17//PLP//A.jpg\"; \n" + "g -> SCREEN;\n";;
...
@Test
public void image4() throws Exception{
	devel = false;
	grade = true;
	String prog = "image4";
	String input = prog 
...
@Test
public void imageGen1() throws Exception{
	devel = false;
	grade = true;
...
@Test
public void imageGen2() throws Exception{
	devel = false;
	grade = true;
...
@Test
public void imageGen6() throws Exception{
	devel = false;
	grade = true;
...
@Test
public void failedOne() throws Exception{
	devel = false;
	grade = true;
	String prog = "prog";
	String input = prog +
